...
export default function SectionFirst({ addSectionRef }: SectionFirstProps) {
	return (
		<section
			...
			className="md:min-h-screen grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-[3fr_2fr] items-center justify-center bg-primary text-primary-content p-16 py-32 gap-16"
		>
