...
export default function SectionSecond({ addSectionRef }: SectionSecondProps) {
	return (
		<section
			...
			className="min-h-screen grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-[1fr_2fr] items-center justify-center bg-primary text-primary-content z-5 p-32 gap-16 pt-48"
		>
